...
void Sprite3D::draw(Renderer* renderer, const cocos2d::Mat4 &transform, bool transformUpdated)
{
...
void Sprite3D::onDraw(const cocos2d::Mat4 &transform, bool transformUpdated)
{
